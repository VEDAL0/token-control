...
class OWL():
    def __init__(self, rpc: AioPresence):
        ...
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN +
              'Do you want with proxies? [Y = proxies, N = proxyless]: ' +
              Fore.RESET,
              end='')
        resp = input()
        if resp.lower() == 'y':
            for proxy in open("proxies.txt"):
                if proxy != '':
                    ...
                    if len(split) == 2:
                        ...
                        self.proxies.append(
                            f"http://{split[2]}:{split[3]}@{split[0]}:{split[1]}"
                        )

    async def start(self):
        try:
            await self.rpc.update(state="Main Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        clear()
    ...
    async def screen1(self):
        try:
            await self.rpc.update(state="Server Joiner Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
            ...
            guildInv = guildInv.replace('https://discord.com/invite/',
                                        '').replace('https://discord.gg/',
                                                    '').replace(
                                                        'discord.gg/', '')
        try:
            await self.rpc.update(state="Using Server Joiner",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        async with TaskPool(5_000) as pool:
            for token in self.tokens:
                await pool.put(
                    self.joinServer(token, guildInv, bypassRulesScreen))
    ...
    async def joinServer(self, token, guildInv, bypassRuleScreen=False):
        ...
        if self.proxyless == False:
            randomProxy = self.proxies[random.randint(0,
                                                      len(self.proxies) - 1)]

        async with ClientSession(headers=headers) as session:
            try:
                async with session.post(
                        "https://discord.com/api/v9/invites/%s" % (guildInv),
                        proxy=randomProxy) as req:
                    if req.status == 429:
                        print('\n                                       ' +
                        ...
                        try:
                            ...
                            if 'message' in json:
                                ...
                                print(
                                    ...
                                    + Fore.BLUE + '[' + Fore.CYAN + '/' +
                                    Fore.BLUE + '] ' + Fore.CYAN +
                                    f'{tk} joined the server!\n' + Fore.RESET)
                                if bypassRuleScreen == True:
                                    async with session.get(
                                            "https://discord.com/api/v9/guilds/"
                                            + json['guild']['id'] +
                                            "/member-verification?with_guild=false&invite_code="
                                            + guildInv) as req2:
                                        if req2.status == 200:
                                            j = await req2.json()
                                            async with session.put(
                                                ...
                                                if req3.status == 201:
                                                    ...
                                                    print(
                                                        ...
                                                        Fore.BLUE + '] ' +
                                                        Fore.CYAN +
                                                        f'{tk} failed to bypass rules screen!\n'
                                                        + Fore.RESET)
                                        else:
                                            print(
                                                '\n                                       '
                ...
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
                      f'{tk} failed to join the server, Proxy Error!\n' +
                      Fore.RESET)
                pass
                ...
                print(
                    '\n                                       ' + Fore.BLUE +
                    '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
                    f'{tk} failed to join the server, Failed to connect to discord.com!\n'
                    + Fore.RESET)
                pass

    async def screen2(self):
        try:
            await self.rpc.update(state="Server Leaver Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if guildId == '0':
            await self.start()
        try:
            await self.rpc.update(state="Using Server Leaver",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def screen3(self):
        try:
            await self.rpc.update(state="Channel Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if replyQues.lower() == 'y':
            ...
            replyMsg = input()
        try:
            await self.rpc.update(state="Using Channel Spammer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def channelSpammer(self,
        ...
        for i in range(int(amount)):
            ...
            randomProxy = ''
            if self.proxyless == False:
                randomProxy = self.proxies[random.randint(
                    0,
                    len(self.proxies) - 1)]
    ...
    async def screen4(self):
        try:
            await self.rpc.update(state="Nickname Changer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if nick == '0':
            await self.start()
        try:
            await self.rpc.update(state="Using Nickname Changer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def screen5(self):
        try:
            await self.rpc.update(state="DM Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if amount == '0':
            await self.start()
        try:
            await self.rpc.update(state="Using DM Spammer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def screen6(self):
        try:
            await self.rpc.update(state="Friend Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if type == 'a' or type == 'add':
            ...
            if userTag == '0':
                await self.start()
            try:
                await self.rpc.update(state="Using Friend Spammer",
                                      details="Sexy Spammer",
                                      large_image="default")
            except:
                pass
    ...
    async def screen7(self):
        try:
            await self.rpc.update(state="Typing Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if chId == '0':
            await self.start()
        try:
            await self.rpc.update(state="Using Typing Spammer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def typingSpammer(self, token, chId):
        ...
        async with ClientSession(headers=headers) as session:
            async with session.post("https://discord.com/api/v9/channels/" +
                                    chId + '/typing',
                                    proxy=randomProxy) as r:
    ...
    async def screen8(self):
        try:
            await self.rpc.update(state="Bio Changer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        if bio == '0':
            await self.start()
        try:
            await self.rpc.update(state="Using Bio Changer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def screen9(self):
        try:
            await self.rpc.update(state="Webhook Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        amount = input()
        try:
            await self.rpc.update(state="Using Webhook Changer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
    ...
    async def webhookSpammer(self, webhookUrl, msg):
        ...
        async with ClientSession(headers=headers) as session:
            async with session.post(webhookUrl,
                                    proxy=randomProxy,
                                    json={"content": msg}) as r:
                if r.status == 204:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'Successfully sent message!\n' +
                          Fore.RESET)
                else:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'Failed to send message!\n' +
                          Fore.RESET)

    async def screen10(self):
        try:
            await self.rpc.update(state="Reaction Spammer Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        try:
            await self.rpc.update(state="Using Reaction Spammer",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        async with ClientSession(headers=headers) as session:
            async with session.put(
                ...
                if r.status == 204:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'{tk} successfully reacted!\n' +
                          Fore.RESET)
                elif r.status == 404:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                    ...
                    if "You need to verify your account" in text:
                        ...
                        print('\n                                       ' +
                              Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                              '] ' + Fore.CYAN + f'{tk} failed to react!\n' +
                              Fore.RESET)
        ...
        async with ClientSession(headers=headers) as session:
            async with session.patch("https://discord.com/api/v9/users/@me",
                ...
                if r.status == 200:
                    ...
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'{tk} couldn\'t change bio!\n' +
                          Fore.RESET)
                else:
                    text = await r.text()
                    if "You need to verify your account" in text:
    ...
    async def screen11(self):
        try:
            await self.rpc.update(state="Token Checker Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        print('                                       ' + Fore.BLUE + '[' +
              Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
              f'Checking Tokens...' + Fore.RESET)
        try:
            await self.rpc.update(state="Using Token Checker",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
            ...
            if resp.lower() == 'y':
                ...
                while added != len(self.checked):
                    ...
                    print('                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN +
                          f'Do you want to go back? [Y/N]: ' + Fore.RESET,
                          end='')
                    r = input()
                    if r.lower() == 'y':
                        self.checked = []
        ...
        async with ClientSession(headers=headers) as session:
            async with session.get(
                ...
                if r.status == 200:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'{tk} is valid!\n' + Fore.RESET)
                    self.checked.append(token)
                elif r.status == 400:
                    print('\n                                       ' +
                          Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                          '] ' + Fore.CYAN + f'{tk} couldn\'t check!\n' +
                          Fore.RESET)
                else:
                    text = await r.text()
                    if "You need to verify your account" in text:
                        ...
                        print('\n                                       ' +
                              Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE +
                              '] ' + Fore.CYAN + f'{tk} failed to check!\n' +
                              Fore.RESET)

    async def screen12(self):
        try:
            await self.rpc.update(state="Contact & Info Screen",
                                  details="Sexy Spammer",
                                  large_image="default")
        except:
            pass
        ...
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'devloper: Vi Vedal.#8888')
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN +
              'https://discord.gg/ره')
        print(" ")
        print(
            ...
            'Info: Hello User, This is ٍVedal, a new spammer for discord. This tool is for spamming discord\'s api and troll servers/users. We want this to be famous and yeah, hope you like it <3.'
        )
        print(" ")
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
    ...
    def exit(self):
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + "Thank you for using Vedal Spammer")
        exit()
    ...
    def sendText(self, screen='main'):
        ...
        print((Fore.MAGENTA + '                            Developed by ' +
               Fore.BLUE + '.*omar#6277' + Fore.MAGENTA + ',' + Fore.BLUE +
               'Vi  Vedal.#8888= ' + Fore.RESET).center(self.center))
        print(' ')
...
class Auth():
    async def start(self):
        ...
        if alreadyPut == true:
            print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
                  Fore.CYAN +
                  'Please provide your serial number from order: ' +
                  Fore.RESET,
                  end='')
            serialNmbr = input()
            try:
                ...
                mongo = pymongo.MongoClient(
                    f'mongodb+srv://{serialNmbr}:owlspammer@rikocluster.5sh7t.mongodb.net/OwlSpammer?retryWrites=true&w=majority'
                )
                ...
                try:
                    await rpc.update(state="Waiting for Proxy Confirmation...",
                                     details="Sexy Spammer",
                                     large_image="default")
                except:
                    pass
